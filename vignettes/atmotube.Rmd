...
✅ Introduces `get_atmotube_data()`  and `get_atmotube_data_bulk()`
...
This vignette provides a quick guide to fetching air quality data using the Atmotube API in R. For further details, refer to the API documentation. Happy coding! 🚀
